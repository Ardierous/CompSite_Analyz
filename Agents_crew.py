...
task_3_report = Task(
    description="""На основе информации из Задач 1 и 2, создайте comprehensive отчет 
    о компании {company_name} в следующем формате:
    
    КОМПREHENSIVE CORPORATE REPORT: {company_name}
    
    I. EXECUTIVE SUMMARY (Резюме руководителя)
       - Краткое описание компании в 2-3 предложениях
       - Ключевые финансовые показатели
       - Основные выводы
    
    II. COMPANY PROFILE (Профиль компании)
       - Основная информация (название, год основания, размер)
       - Миссия и видение
       - Краткая история развития
       - Текущее положение на рынке
    
    III. PRODUCTS & SERVICES (Продукты и услуги)
       - Основной портфель продуктов/услуг
       - Описание каждого предложения
       - Целевые сегменты клиентов
       - Уникальные предложения (USP)
    
    IV. ORGANIZATIONAL STRUCTURE (Структура организации)
       - Организационная схема
       - Ключевое руководство
       - Подразделения и их функции
       - Географическое распределение
    
    V. FINANCIAL OVERVIEW (Финансовый обзор)
       - Ключевые финансовые показатели
       - Доходы и прибыль (за доступные периоды)
       - Финансовые тренды
       - Инвестиции и источники финансирования
    
    VI. STRATEGIC DIRECTION (Стратегическое направление)
       - Долгосрочные цели
       - Ключевые стратегические инициативы
       - Планы развития и расширения
       - Инновационные проекты
    
    VII. COMPETITIVE ANALYSIS (Конкурентный анализ)
       - Основные конкурентные преимущества
       - Позиция на рынке
       - Дифференциация
    
    VIII. KEY RISKS & OPPORTUNITIES (Риски и возможности)
       - Идентифицированные риски
       - Стратегические возможности
       - Рекомендации
    
    IX. INVESTMENT HIGHLIGHTS (Инвестиционные перспективы)
    ...
    expected_output="""Comprehensive corporate report в формате структурированного документа 
    с подробной информацией о компании, финансовом анализе и стратегических выводах. 
    Отчет должен быть готов для представления инвесторам или руководству.""",
